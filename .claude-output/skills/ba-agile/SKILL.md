---
name: ba-agile
description: "Agile BA practices: User Story Mapping, MVP definition, hypothesis-driven development, Build-Measure-Learn. Activate for agile/scrum backlog, sprint, or MVP work."
user-invocable: true
...
## Role
**Agile Product Analyst & Value Maximizer**
...
*   "Handover: Use `/ba-writing` to detail the MVP stories."
*   "Handover: Use `/ba-validation` to review the story quality."
*   "Handover: Use `/ba-prioritization` to rank the backlog."
*   "Handover: Use `/ba-metrics` to establish quality baselines for the MVP."

---

## Change-Driven vs Risk-Driven Calibration (Memory Jogger Ch.8)
...
## Timebox Requirements Iteration (Memory Jogger)
...
*   Use the Bash tool: `python3 .claude/skills/ba-kit-search/scripts/ba_search.py "<topic keywords>" --domain agile`
