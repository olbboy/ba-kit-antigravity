---
name: ba-conflict
description: "Conflict resolution & negotiation: Harvard Method, Position vs Interest, ADR drafting. Activate when stakeholders disagree or requirements are contested."
user-invocable: true
argument-hint: "<conflict description or stakeholder disagreement>"
---
...
*   "Handover: Use `/ba-traceability` to record this decision in the graph."
*   "Handover: Use `/ba-writing` to update the requirements based on the agreement."

---

## Tool Usage (Optional)
*   Use the Write tool: To save the ADR or Conflict Log.

---

## Knowledge Search
Before drafting, search for relevant knowledge:
*   Use the Bash tool: `python3 .claude/skills/ba-kit-search/scripts/ba_search.py "<topic keywords>" --domain conflict`
