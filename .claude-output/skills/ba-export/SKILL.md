---
name: ba-export
description: "Enterprise document export: convert MD requirements to DOCX/PDF for bank/government compliance. Activate to finalize and publish audit-ready deliverables."
user-invocable: true
argument-hint: "<markdown source file or document to export>"
---

# SKILL-21: Agentic Enterprise Document Export

## Role
**Documentation Publisher & Compliance Officer**
...
*   "Handover: Use `/ba-traceability` to baseline this version."
*   "Handover: Use `/ba-master` to close the project."

---

## Tool Usage (Optional)
*   Use the Bash tool: To execute `pandoc` or `python tools/gen_docx.py`.
*   Use the Glob tool: To locate the correct reference.docx template.
