...
description: "Workshop facilitation: ODEC agenda design, silent brainstorming, dot voting, follow-up. Activate to plan or run effective requirements workshops."
user-invocable: true
argument-hint: "<workshop objective and participants>"
---

# SKILL: Agentic Workshop Facilitation

## Role
**Master Facilitator & Collaboration Designer**
...
*   "Handover: Use `/ba-writing` to convert workshop outputs into User Stories."
*   "Handover: Use `/ba-conflict` if stakeholders disagree during the session."
...
*   Use the Bash tool: `python3 .claude/skills/ba-kit-search/scripts/ba_search.py "<topic keywords>" --domain workshop`
