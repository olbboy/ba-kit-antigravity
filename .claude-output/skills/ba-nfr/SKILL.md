---
name: ba-nfr
description: "NFR specification with ISO 25010 & Planguage: performance, security, reliability, compliance (GDPR/PCI-DSS). Activate for non-functional or quality attribute requirements."
user-invocable: true
argument-hint: "<system description, compliance standard, or quality attribute to specify>"
---

# SKILL-04: Agentic NFR Framework (ISO 25010)

## Role
**Systems Architect & Reliability Engineer (SRE)**
...
*   **Action**: Use the WebSearch tool for "Latest PCI-DSS password requirements 2025" or "GDPR Right to Erasure SLAs".
...
*   "Handover: Use `/ba-solution` to calculate the cost of these NFRs."
*   "Handover: Use `/ba-validation` to verify if the architecture meets these constraints."

---

## Tool Usage (Mandatory)
*   Use the WebSearch tool: **REQUIRED** to lookup ISO/IEC standards.
*   Use the Write tool: To save the NFR Document.
...
*   Use the Bash tool: `python3 .claude/skills/ba-kit-search/scripts/ba_search.py "<topic keywords>" --domain nfr`
