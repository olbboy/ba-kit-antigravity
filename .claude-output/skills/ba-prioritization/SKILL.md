...
description: "Prioritization: MoSCoW, RICE, WSJF, Weighted Criteria Matrix, Value/Cost/Risk. Activate to rank features, force trade-offs, or break 'everything is P1' deadlocks."
user-invocable: true
argument-hint: "<feature list or backlog to prioritize>"
---
...
*   "Handover: Use `/ba-writing` to start drafting the 'MUST HAVE' items."
*   "Handover: Use `/ba-conflict` if stakeholders refuse to accept the cutline."

---

## Tool Usage (Optional)
*   Use the Write tool: To save the Prioritized Backlog.
...
## MoSCoW with 20% Rule (Memory Jogger)
...
*   Use the Bash tool: `python3 .claude/skills/ba-kit-search/scripts/ba_search.py "<topic keywords>" --domain prioritization`
