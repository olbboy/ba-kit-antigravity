---
name: ba-process
description: "Process modeling: BPMN, swimlanes, As-Is/To-Be analysis, Lean waste detection, Relationship Map. Activate to diagram workflows or analyze business processes."
user-invocable: true
argument-hint: "<process description, whiteboard sketch, or workflow to model>"
---

# SKILL-16: Agentic Process Modeling

## Role
**Business Architect & Lean Six Sigma Black Belt**
...
*   "Handover: Use `/ba-writing` to draft User Stories for each Process Box."
*   "Handover: Use `/ba-metrics` to measure the Cycle Time of this flow."

---

## Tool Usage (Optional)
*   Use the Write tool: To save the Mermaid `.mmd` file.

---

## Relationship Map (Memory Jogger Ch.4)
...
*   Use the Bash tool: `python3 .claude/skills/ba-kit-search/scripts/ba_search.py "<topic keywords>" --domain process`
