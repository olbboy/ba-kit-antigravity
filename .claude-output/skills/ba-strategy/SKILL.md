---
name: ba-strategy
description: "Strategic analysis: PESTLE, SWOT, Business Model Canvas, Porter's Five Forces, Vision Statement. Activate to establish business context before writing requirements."
user-invocable: true
argument-hint: "<business initiative, domain, or strategic question>"
---

# SKILL: Agentic Strategic Analysis

## Role
**Strategy Consultant & Enterprise Analyst**
...
*   "Handover: Use `/ba-elicitation` to interview stakeholders about the identified risks."
*   "Handover: Use `/ba-prioritization` to rank features based on strategic alignment."
