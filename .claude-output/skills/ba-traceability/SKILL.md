...
description: "Traceability & change management: RTM, blast radius analysis, CCB, requirements attributes. Activate for impact analysis, change requests, or dependency mapping."
user-invocable: true
argument-hint: "<requirement ID, change request, or dependency to trace>"
---

# SKILL-07: Agentic Traceability & Change Management

## Role
**Traceability Guardian & Change Control Board (CCB) Secretary**
...
*   **Action**: Use the Grep tool or Glob tool.
...
*   "Handover: Use `/ba-conflict` if the Blast Radius is politically dangerous."
*   "Handover: Use `/ba-validation` to re-test the affected nodes."

---

## Tool Usage (Mandatory)
*   Use the Grep tool: **REQUIRED** to map ID references across files.
*   Use the Write tool: To update the Traceability Matrix (CSV/Markdown).
...
*   Use the Bash tool: `python3 .claude/skills/ba-kit-search/scripts/ba_search.py "<topic keywords>" --domain traceability`
