...
<p align="center">
  <img src="https://img.shields.io/badge/Phiên%20bản-3.5.0-blue?style=for-the-badge" alt="Phiên bản 3.5.0">
...
> 📐 **Sprint Spine** — toàn bộ 44 agents map vào vòng lặp 7 phase: **Discover → Elicit → Define → Validate → Prioritize → Publish → Reflect**. Xem [`docs/sprint-spine.md`](docs/sprint-spine.md) để biết chi tiết mapping agent → phase.
