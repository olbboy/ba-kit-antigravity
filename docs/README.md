...
> 44 agents · 831 knowledge entries · 14 templates · 48 prompts · 3 platforms
...
| 2 | [Usage Guide](./usage-guide.md) | Hiểu cách 44 agents hoạt động, workflow chains | 10 min |
...
| [Antigravity Protocol](./antigravity-protocol.md) | Runtime spec cho Antigravity IDE — 44 agents, tool mandates |
...
| Agent Skills | [`.agent/skills/ba-*/`](../.agent/skills/) | 44 SKILL.md files — source of truth cho mỗi agent |
